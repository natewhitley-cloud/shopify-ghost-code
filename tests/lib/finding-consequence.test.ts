 ...
 *   - Partition: PRIMARY lanes cleanly partition all 31 types (each in exactly one).
...
// ---------------------------------------------------------------------------
// Partition: primary lanes cleanly cover all 31 types
// ---------------------------------------------------------------------------

describe("typesForLane partition", () => {
  it("primary lanes partition all 31 types with no type in two lanes", () => {
