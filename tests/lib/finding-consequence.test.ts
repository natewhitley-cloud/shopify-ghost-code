 ...
 *   - Partition: PRIMARY lanes cleanly partition all 29 types (each in exactly one).
...
// ---------------------------------------------------------------------------
// Partition: primary lanes cleanly cover all 29 types
// ---------------------------------------------------------------------------

describe("typesForLane partition", () => {
  it("primary lanes partition all 29 types with no type in two lanes", () => {
