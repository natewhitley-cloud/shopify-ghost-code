 ...
 *   - Partition: PRIMARY lanes cleanly partition all 28 types (each in exactly one).
...
// ---------------------------------------------------------------------------
// Partition: primary lanes cleanly cover all 28 types
// ---------------------------------------------------------------------------

describe("typesForLane partition", () => {
  it("primary lanes partition all 28 types with no type in two lanes", () => {
