...
**Purpose:** The workhorse tier. Merchants can scan freely, see exactly what needs cleaning up, and track their theme health over time.
...
3. **Auto-rescan skipped** — Theme publish webhooks arrive but scans are silently skipped on non-Pro plans. Passive trigger (user doesn't see it unless they notice scans aren't auto-running).
